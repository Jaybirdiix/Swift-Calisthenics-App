...
def main():
    ...
    ap.add_argument("--exercises", default="../Data/exercises.json", help="Path to exercises JSON file")
...
python deterministic_random_workout.py \
  --focus "anterior deltoid,triceps,lats" \
  --band intermediate \
  --minutes 40 \
  --equipment "floor,bar" \
  --rand 0.25 --topk 6 --seed 123 \
  --out plan.json