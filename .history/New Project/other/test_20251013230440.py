...
# Let unsupported MPS ops run on CPU (works across versions)
os.environ.setdefault("PYTORCH_ENABLE_MPS_FALLBACK", "1")

import torch
torch._dynamo.config.suppress_errors = True

# No-op torch.compile that works both as fn and decorator-factory
...
# DON'T call torch.backends.mps.enable_mps_fallback(...) — not needed / may not exist
